...
> 详情见 references/平台实战经验与成长建议.md。包含流量池分级、互动权重、开篇要求、读者画像与常见误区等平台研究数据，执行今日头条版改写前必须读取。
...
- `references/平台实战经验与成长建议.md` — 流量池分级、互动权重、开篇要求等平台研究数据
- `references/POV选择指南.md` — 今日头条版人-称适用场景分析
...
> 详情见 references/POV选择指南.md。包含今日头条版人称适用场景分析与基线表创建说明，无上游契约时必须读取。
## 章节题图与配图提示词（每章必出）
