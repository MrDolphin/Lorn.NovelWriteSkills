...
- 报告至少要完整覆盖：评估任务与材料完整度、阅读链路与证据基础、**外部榜单检索记录、起点同题材 Top 10 候选池、`3–5` 本主压制样本四层深拆速览、Top 10 逐本深搜记录与从严对照结论**、投稿门槛核验、平台快审模拟（30 秒 / 3 分钟 / 3 万字或首卷）、十维评分（含“竞对差距与超越路径”25分权重）、红线 / 封顶 / 风险分级、卖点保真与平台归类、开篇与章级追读工程、人物 / 关系 / 付费价值、机制 / 设定 / 现实锚点、长线架构 / 分卷续航、更新执行 / 投稿包成熟度、最小修复闭环、概率上下限解释与明确动作结论。
