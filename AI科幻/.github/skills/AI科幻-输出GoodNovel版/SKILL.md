...
description: '用于【AI科幻】题材下的 GoodNovel 平台输出任务。作为题材包装层、兼容入口与路由层，负责保留AI科幻入口、补充关系张力与现实调查边界，并明确要求加载并使用 `通用-输出GoodNovel版`。关键词：AI科幻GoodNovel版、英文平台、关系张力、调查悬疑。'
...
- 重点保留AI科幻中的调查推进、情绪代价、人物关系拉扯与证据压力。
